...
| :--- | :--- | :--- |
| <img src="https://github.com/devicons/devicon/blob/master/icons/java/java-original-wordmark.svg" title="Java" alt="Java" width="40" height="40"/>| **[Rogue](https://github.com/Shyrasya/Rogue)**<br> **[TicTacToe](https://github.com/Shyrasya/Tictactoe)**<br> **[Фильтр полетов](https://github.com/Shyrasya/FlightsFilter)** <br> **[Калькулятор отпускных](https://github.com/Shyrasya/VacationPayCalculator)**<br> **[Управление банковскими картами](https://github.com/Shyrasya/BankCardManagmentSystems)** | Консольная rogue-like игра<br>Веб-приложение "Крестики-Нолики"<br>Консольное приложение для фильтрации авиарейсов<br>Веб-API для расчёта отпускных<br> Веб-API для карт: переводы, лимиты, транзакции |
